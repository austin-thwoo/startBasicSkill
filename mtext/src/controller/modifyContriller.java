...
/**
 * Servlet implementation class modifyContriller
 */
@WebServlet("/modifyForm")
public class modifyContriller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public modifyContriller() {
        super();
...
//    	${mem.userId1}는 input태그로 볼때 입력한 값 or value값
    	...
    	request.setAttribute("memberModify", memberModify);//번째memberView는 jsp에서 사용할꺼 두번째는 우리가 넘겨준는 변수이름
