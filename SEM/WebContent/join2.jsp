	...
	<div class="join_container">
		...
		<%--아이디 : ${uID}--%>
				 <input type="text" class="input" style="ime-mode: disabled;"
					placeholder="아이디" name="userID" id="check" title="아이디" maxlength="20">
		<button type="button" value="userID" name="overlap" onclick="overlapg()" style="WIDTH: 100pt; HEIGHT: 25pt">overlapconr</button>
	
		<c:if test="${check eq 1}">
		 <script> alert("아이디사용불가");</script>
		 <h3>이미 사용중인 아이디 입니다.</h3>
			...
			<h3>전화번호</h3>
			<div class="joinPhone">
				<input type="text" class="input" placeholder="'-'없이 입력해 주세요." name="userPhone">
			</div>
			<h3>성별</h3>
